...
如果 \forall \varepsilon \gt 0, 存在 \delta \gt 0, 当 P(x, y) \in D,且 0 \lt \sqrt{(x - x_0)^2 + (y - y_0)^2} \lt \delta 时，都有\\
...
定理2（极值的充分条件）
$$
设 z = f(x, y) 在点 (x_0, y_0) 的某邻域内有二阶连续偏导数，又 f'_x (x_0, y_0), f'_y (x_0, y_0) = 0. 记 \\
